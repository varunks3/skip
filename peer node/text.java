...
public class text {
    public static void main(String[] args) throws IOException {
        ...
        File kgc = new File("peer node/kgc.txt");
        File kpa1 = new File("peer node/kpa1.txt");
        File kpa2 = new File("peer node/kpa2.txt");
        File kpa3 = new File("peer node/kpa3.txt");
        File kpa4 = new File("peer node/kpa4.txt");
        File kpa5 = new File("peer node/kpa5.txt");
        File kpa6 = new File("peer node/kpa6.txt");
